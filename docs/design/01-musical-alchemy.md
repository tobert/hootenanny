...
EmotionalVector {
    ...
    agency: f32,     // The initiative-responsiveness axis (-1.0 to 1.0)
}
```
...
- **Agency**: The degree of self-direction, from responsive listening (-1.0) to leading with initiative (1.0).
...
1. **The Realm of Jubilation** (+ + +): High valence, high arousal, high agency
   - *The territory of triumph, celebration, and joyful leadership*

2. **The Garden of Contentment** (+ - +): High valence, low arousal, high agency
   - *The space of satisfied contemplation and quiet confidence*

3. **The Valley of Melancholy** (- - -): Low valence, low arousal, low agency
   - *The depths of resignation and quiet sorrow*

4. **The Storm of Rage** (- + +): Low valence, high arousal, high agency
   - *The fury of righteous anger and aggressive initiative*

5. **The Cave of Despair** (- + -): Low valence, high arousal, low agency
   - *The panic of loss and overwhelming grief*

6. **The Shore of Longing** (+ - -): High valence, low arousal, low agency
   - *The bittersweet ache of nostalgia and tender vulnerability*

7. **The Mountain of Determination** (- - +): Low valence, low arousal, high agency
   - *The grim resolve and stoic endurance*

8. **The Dance of Ecstasy** (+ + -): High valence, high arousal, low agency
...
dissonance = (arousal * 0.6)
           ...
           + (|agency| < 0.3 ? 0.1 : 0)  // Uncertainty adds tension

// The Modulation Probability
modulation_rate = arousal * (1.0 - |agency|) * 0.5
                 // High arousal + low agency = harmonic wandering
```
...
#### Agency → Rhythmic Attitude

**The Leading Rhythm** (agency > 0.5):
- On-the-beat emphasis, driving downbeats
- Rhythmic patterns that command attention
- *"Every beat is a clear statement"*

**The Conversational Rhythm** (-0.5 < agency < 0.5):
- Natural flow, give-and-take phrasing
- Mix of on-beat and off-beat accents
- Rhythmic dialogue between voices
- *"The rhythm breathes with life"*

**The Supporting Rhythm** (agency < -0.5):
- Behind-the-beat placement, laid-back feel
- Syncopation that avoids strong beats
- Rhythmic hesitation, following the pulse
- *"The rhythm yields, flows, supports"*
...
polyrhythm_probability = arousal * (1.0 - |valence|) * |agency|
                       // Complex emotions create complex time
```

### The Sacred Rhythmic Patterns

**The Heartbeat** (Low arousal, any valence, neutral agency):
```
█ · · · █ · · · █ · · · █ · · ·
```
*The fundamental pulse of life, steady and eternal*

**The Anxiety Flutter** (High arousal, negative valence, low agency):
```
█·█·█·█·█·█·█·█·█·█·█·█·
```
*Rapid, irregular, never quite settling*

**The Victory March** (High arousal, positive valence, high agency):
```
█ · · █ · · █ █ █ · · · █ !
```
...
#### Agency → Attack and Envelope

**High Agency ADSR:**
```
Attack:  Fast (< 10ms) - Immediate presence
Decay:   Short - No hesitation
Sustain: High (> 0.8) - Maintaining presence
...
Release: Long - Fading out gracefully
```
...
dynamic_range = arousal * 0.5
              + (1.0 - |agency|) * 0.3
              // High arousal OR low agency = more dynamic variety

// Crescendo/Diminuendo Tendency
dynamic_direction = agency * 0.6 + (arousal - 0.5) * 0.4
...
cutoff = base_freq
       ...
       * (1.0 + agency * 0.3)       // Agency cuts through
...
LFO_depth = (1.0 - |agency|)        // Low agency creates wobble
...
| Emotion State | Valence | Arousal | Agency | Musical Character |
|--------------|---------|---------|--------|-------------------|
...
impl EmotionalVector {
    ...
    pub fn with_noise(&self, amount: f32) -> EmotionalVector {
        ...
        EmotionalVector {
            ...
            agency: self.agency + random_gaussian() * amount * 0.7,
        }
    }
}
```
